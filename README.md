...
You can try [InboxPilot](https://www.inboxpilot.xyz/login) with the following credentials:
...
- `"All emails from john@example.com"`
- `"Messages about job interviews"`
- `"Emails on Monday"`
- `"Emails before 10th June"`
- `"All flagged emails from May"`
- `"Spam from last week"`
- `"Show messages with 'invoice' in the subject"`
